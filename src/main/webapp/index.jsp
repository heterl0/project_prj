<%-- Document : index Created on : Oct 26, 2022, 8:58:55 PM Author : Heterl0 --%>
...
<html>
    ...
    <body>
        <div class="hero_area">
            ...
            <section class="slider_section ">
                <div class="slider_bg_box">
                    <img src="Image_Perfume/Chance-Eau-Tendre_1.jpg" alt="">
                </div>
        ...
        <section class="why_section layout_padding">
            <div class="container">
                <div class="heading_container heading_center">
                    <h2>
                        Tại sao nên chọn website chúng tôi?
                    </h2>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="box ">
                            ...
                            <div class="detail-box">
                                ...
                                <p>
                                    Miễn phí vận chuyện cho quan đường ngằn hơn 3km.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="box ">
                            ...
                            <div class="detail-box">
                                ...
                                <p>
                                    Giao hàng tới khắp các tỉnh thành trên cả nước chỉ với 18.000đ!
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="box ">
                            ...
                            <div class="detail-box">
                                ...
                                <p>
                                    Hàng nhập khẩu từ nước ngoài, 100% chính hàng.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <%             ProductDAO pdao = new ProductDAO();
            Product[] productByReleaseYear = pdao.getProductOrderByReleaseYear();
        %>
        <section class="arrival_section">
            <div class="container">
                <div class="pt-md-5" style="margin-bottom:-30px">
                    <div class="row">
        ...
        <section class="product_section layout_padding">
            <div class="container">
                <div class="heading_container heading_center">
                    <h2>
                        Nước hoa <span>bán chạy nhất</span>
                    </h2>
                </div>
                <div class="row">
                    <div class="row">
                        <%
                            Product[] productsMostSold = pdao.getProductOrderByMostSold();
                            for (int i = 0; i < 3; i++) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 ml-auto">
                            <div class="text-center">
                                <img class="" width=300px src="Image_Perfume/20614583_1773364176012203_1842498205_n-1-700x850.jpg">
                            </div>
                        </div>
                    </div>
                </div>
