                        ...
                        <div class="flex-row">
                            ...
                            %>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtName" aria-describedby="nameHelp" placeholder="Nhập tên của bạn" value="<%= customer.getCustomer_name() %>" required>
                                    <small id="nameHelp" class="form-text text-muted"></small>
                                  </div>
                                <div class="form-group">
                                  <label for="txtPhone">Số điện thoại</label>
                                  <input type="text" class="form-control" id="txtPhone" aria-describedby="phoneHelp" placeholder="Nhập số điện thoại" value="<%= accountDAO.getAccountBy(account_id).getAccount_phone()  %>"readonly>
                                  <small id="phoneHelp" class="form-text text-muted"></small>
                                </div>
                                <div class="form-group">
                                    <label for="txtEmail">Địa chỉ Email</label>
                                    <input type="email" class="form-control" id="txtEmail" aria-describedby="emailHelp" placeholder="Nhập Email" value="<%= customer.getCustomer_email() %>">
                                    <small id="emailHelp" class="form-text text-muted"></small>
                                  </div>
                                  <div class="form-group">
                                    <label for="txtAddress">Địa chỉ liên lạc</label>
                                    <input type="text" class="form-control" id="txtAddress" aria-describedby="addressHelp" placeholder="Nhập địa chỉ" value="<%= customer.getCustomer_address() %>" required>
