...
<html>
    ...
    <body class="sub_page">
        <% int product_id = Integer.parseInt(request.getParameter("product_id"));
            ...
            ProductVolume[] pv = volumeDAO.getProductVolumesByProductId(product_id);
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="right">
                            ...
                            <div class="row mb-2">
                                <% 
                                    for (ProductVolume productVolume : product.getProduct_volumes()) {
                                %>
                                <div class="col-sm-3 product_price" onclick="showPrice(this)">
                                    <p class="text-center">EDP <%= productVolume.getProduct_volume()  %><br />
                                        <b><%= productVolume.getProduct_price()  %></b>
                                    </p>
                                </div>
                                <% 
                                    }
        ...
        <script>
                                    ...
                                    function showPrice(priceChoose) {
                                        price.innerHTML = priceChoose.childNodes[1].innerHTML;
                                    }
        </script>
    </body>
